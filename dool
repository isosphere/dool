...
class Options:
    def __init__(self, args):
        ...
        long_opts = [
            ...
            'noheaders', 'noupdate'   , 'profile' , 'version', 'vmstat' , 'color-invert'
        ]
        ...
        for opt, arg in opts:
            ...
            elif opt in ['--color-invert']:
                self.colorinvert = True
            elif opt in ['--color']:
                self.color = 256
                self.update = True
            elif opt in ['--color16']:
...
Dool options:
  ...
  --colorinvert            color scales are inverted (high is red, low is green)
...
def set_theme():
    ...
    # red means high, green means low
    elif op.colorinvert:
        theme = {
            'title'     : color['darkblue'],
            ...
            'unit_lo'   : color['gray'],
            'unit_hi'   : color['darkgray'],
            'colors_lo' : tuple(reversed((color['red'], color['darkred'], color['yellow'], color['cyan'],
                          color['blue'], color['green'], color['darkgreen'], color['white']))),            
        }
        theme['colors_hi'] = theme['colors_lo']
    else:
        theme = {
            'title'     : color['darkblue'],
            'subtitle'  : color['blue'] + ansi['underline'],
